  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content={`https://dicespec.vercel.app/api/og?image=${encodeURIComponent(ogpUrl)}`} />
        ...
        <meta name="twitter:image" content={`https://dicespec.vercel.app/api/og?image=${encodeURIComponent(ogpUrl)}`} />
      </Head>
    </>
  );
};
