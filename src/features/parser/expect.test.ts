...
describe('Dice Expecter', () => {
  it('calcExpectedValue', () => {
    ...
    expect(calcExpectedValue('1d6 + 1d6 - 3')).toEqual({
      mean: 4,
    ...
    expect(calcExpectedValue('1d6 * 1d6 * 2 + 5')).toEqual({
      mean: 3.5 ** 2 * 2 + 5,
    ...
    expect(calcExpectedValue('3d6 + 1d100 + 1')).toEqual({
      mean: 3.5 * 3 + 50.5 + 1,
